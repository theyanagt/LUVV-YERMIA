...
handler.help = ['akira', 'akiyama', 'asuna', 'ayuzawa', 'boruto', 'chiho', 'chitoge', 'deidara', 'erza', 'elaina', 'eba', 'emilia', 'hestia', 'hinata', 'inori', 'isuzu', 'itachi', 'itori', 'kaga', 'kagura', 'kaori', 'keneki', 'kotori', 'kurumi', 'madara', 'mikasa', 'miku', 'minato', 'naruto', 'nezuko', 'sagiri', 'sasuke', 'sakura', 'shota', 'waifu2', 'yotsuba', 'shinomiya', 'yumeko', 'tejina', 'shizuka', 'gremory', 'shina', 'tsunade', 'onepiece', 'boneka-chucky', 'toukachan', 'pokemon']
handler.tags = ['anime']
